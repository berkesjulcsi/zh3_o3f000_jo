...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=softech2.database.windows.net;Initial Catalog=probaadatb;User ID=hallgato;Password=Password123");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Csomagok>(entity =>
        {
            entity.HasKey(e => e.CsomagId).HasName("PK__Csomagok__EA4589356D6FE552");
        ...
        {
            entity.HasKey(e => e.DolgozóId).HasName("PK__Dolgozók__4C4A08431BDBF708");
        ...
        {
            entity.HasKey(e => e.ÜgyfélId).HasName("PK__Ügyfelek__F96A0D47E906EAA5");
        ...
        {
            entity.HasKey(e => e.ÜgyintézésId).HasName("PK__Ügyintéz__25D48A479967DC05");

            entity.ToTable("Ügyintézések");

            entity.Property(e => e.ÜgyintézésId).HasColumnName("ÜgyintézésID");
            entity.Property(e => e.DolgozóId).HasColumnName("DolgozóID");
        ...
        {
            entity.HasKey(e => e.ÜzletId).HasName("PK__Üzletek__0BC13BF6F82F8D05");
